...
def problem1(square, thickness, window):
    ...
    m = square.center.x
    v = square.center.y
    n = square.length_of_each_side
    cc = rg.Circle(rg.Point(m,v + n) , n / 2)
    cc.fill_color = square.fill_color
    cc.outline_thickness = thickness
    cc.attach_to(window)
    l =rg.Line(cc.center,rg.Point(m - (n / 2), v))
